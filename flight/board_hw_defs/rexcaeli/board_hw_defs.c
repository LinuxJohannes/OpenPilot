...
/* Flash/Accel/Gyro Interface
 * 
 * NOTE: Leave this declared as const data so that it ends up in the 
 * .rodata section (ie. Flash) rather than in the .bss section (RAM).
 */
void PIOS_SPI_flash_accel_gyro_irq_handler(void);
void DMA1_Channel4_IRQHandler() __attribute__ ((alias ("PIOS_SPI_flash_accel_gyro_irq_handler")));
void DMA1_Channel5_IRQHandler() __attribute__ ((alias ("PIOS_SPI_flash_accel_gyro_irq_handler")));
static const struct pios_spi_cfg pios_spi_flash_accel_gyro_cfg = {
	.regs   = SPI2,
	.init   = {
		...
		.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_16, // SPI_BaudRatePrescaler_8,
	},
	.use_crc = false,
	.dma = {
	...
	.slave_count = 3,
	.ssel = {{
		.gpio = GPIOB,		// SPI Flash
		.init = {
			.GPIO_Pin   = GPIO_Pin_12,
			.GPIO_Speed = GPIO_Speed_50MHz,
			.GPIO_Mode  = GPIO_Mode_Out_PP,
		}},{
			.gpio = GPIOA,	// SPI LSM330DL Acc
			.init = {
				.GPIO_Pin   = GPIO_Pin_7,
				.GPIO_Speed = GPIO_Speed_50MHz,
				.GPIO_Mode  = GPIO_Mode_Out_PP,
		}},{
			.gpio = GPIOC,	// SPI LSM330DL Gyro
			.init = {
				.GPIO_Pin   = GPIO_Pin_5,
				.GPIO_Speed = GPIO_Speed_50MHz,
				.GPIO_Mode  = GPIO_Mode_Out_PP,
...
static uint32_t pios_spi_flash_accel_gyro_id;
void PIOS_SPI_flash_accel_gyro_irq_handler(void)
{
	/* Call into the generic code to handle the IRQ for this specific device */
	PIOS_SPI_IRQ_Handler(pios_spi_flash_accel_gyro_id);
}
